"""Adds config flow for Control4Dimmers."""
...
from .api import (
    Control4DimmersApiClient,
    Control4DimmersApiClientAuthenticationError,
    Control4DimmersApiClientCommunicationError,
...
class Control4DimmersFlowHandler(config_entries.ConfigFlow, domain=DOMAIN):
    """Config flow for Control4Dimmers."""
    ...
    async def async_step_user(
        ...
        if user_input is not None:
            try:
                ...
                _errors["base"] = "auth"
            except Control4DimmersApiClientCommunicationError as exception:
