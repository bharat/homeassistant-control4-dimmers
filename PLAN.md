...
**Exploration repo** (archived in `exploration/`): 7 sessions of reverse-engineering (Feb 7-10, 2026). Contains the original Z2M converter, protocol docs, and device probe scripts.
...
Exploration repo imported into `exploration/` with full commit history. Plan committed as `PLAN.md`.
...
2. Set up `z2m/` directory with converter and Docker build -- **DONE**
